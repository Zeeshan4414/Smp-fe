...
const Settings = () => {
    ...
    return (
        <div className="max-w-4xl mx-auto p-6 bg-white rounded-lg shadow-md">
          ...
          <div className="mb-8">
            <h3 className="text-2xl font-medium text-gray-700 mb-4">Update Email</h3>
            <div className="flex items-center space-x-4">
              ...
              <button
                ...
                className="px-3 py-3 bg-blue-500 text-white rounded-lg hover:bg-blue-700 transition duration-300"
              >
                Update Email
              </button>
            </div>
